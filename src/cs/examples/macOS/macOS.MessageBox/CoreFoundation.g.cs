// <auto-generated>
//  This code was generated by the following tool on 2022-05-10 20:06:35 GMT-04:00:
...
using static macOS.MessageBox.CoreFoundation.Runtime;

namespace macOS.MessageBox
{
    public static unsafe partial class CoreFoundation
    {
        private const string LibraryName = "/System/Library/Frameworks/CoreFoundation.framework/Versions/A/CoreFoundation";
        ...
        public struct CFURLRef
        {
            ...
            public static implicit operator void*(CFURLRef data) => data.Data;
            public static implicit operator CFURLRef(void* data) => new() { Data = data };
        }
        ...
        public struct CFOptionFlags
        {
            ...
            public static implicit operator ulong(CFOptionFlags data) => data.Data;
            public static implicit operator CFOptionFlags(ulong data) => new() { Data = data };
        }
        ...
        #region C2CS.Infrastructure.Runtime
