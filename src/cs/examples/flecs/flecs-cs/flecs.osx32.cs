...
//-------------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated (07/15/2021 01:36:11 UTC) by the following tool:
...
public static unsafe partial class flecs
{
    ...
    [DllImport(LibraryName)]
    public static extern void ecs_record_move_to(ecs_world_t* world, ecs_record_t* r, int column, uint size, void* value, int count);

    // Function @ direct_access.h:292:6 (/Users/lstranks/Programming/c2cs/ext/flecs/include/flecs/addons/direct_access.h)
    [DllImport(LibraryName)]
    public static extern void ecs_record_copy_pod_to(ecs_world_t* world, ecs_record_t* r, int column, uint size, void* value, int count);

    // Function @ direct_access.h:271:6 (/Users/lstranks/Programming/c2cs/ext/flecs/include/flecs/addons/direct_access.h)
    [DllImport(LibraryName)]
    public static extern void ecs_record_copy_to(ecs_world_t* world, ecs_record_t* r, int column, uint size, void* value, int count);

    // Function @ direct_access.h:249:7 (/Users/lstranks/Programming/c2cs/ext/flecs/include/flecs/addons/direct_access.h)
    [DllImport(LibraryName)]
    public static extern void* ecs_record_get_column(ecs_record_t* r, int column, uint size);
    ...
    [DllImport(LibraryName)]
    public static extern ecs_entity_t ecs_import(ecs_world_t* world, ecs_module_action_t module, CString module_name, void* handles_out, uint handles_size);
    ...
    [DllImport(LibraryName)]
    public static extern uint ecs_iter_column_size(ecs_iter_t* it, int index);

    // Function @ flecs.h:3247:7 (/Users/lstranks/Programming/c2cs/ext/flecs/include/flecs.h)
    [DllImport(LibraryName)]
    public static extern void* ecs_iter_column_w_size(ecs_iter_t* it, uint size, int index);
    ...
    [DllImport(LibraryName)]
    public static extern uint ecs_term_size(ecs_iter_t* it, int index);
    ...
    [DllImport(LibraryName)]
    public static extern void* ecs_term_w_size(ecs_iter_t* it, uint size, int index);
    ...
    [DllImport(LibraryName)]
    public static extern uint ecs_id_str(ecs_world_t* world, ecs_id_t entity, CString buffer, uint buffer_len);
    ...
    [DllImport(LibraryName)]
    public static extern ecs_entity_t ecs_set_id(ecs_world_t* world, ecs_entity_t entity, ecs_id_t id, uint size, void* ptr);
    ...
    [DllImport(LibraryName)]
    public static extern uint ecs_table_column_size(ecs_iter_t* it, int column);
    ...
    [DllImport(LibraryName)]
    public static extern uint ecs_column_size(ecs_iter_t* it, int column);
    ...
    [DllImport(LibraryName)]
    public static extern void* ecs_element_w_size(ecs_iter_t* it, uint size, int column, int row);
    ...
    [DllImport(LibraryName)]
    public static extern void* ecs_column_w_size(ecs_iter_t* it, uint size, int column);
    ...
    [DllImport(LibraryName)]
    public static extern uint ecs_entity_str(ecs_world_t* world, ecs_id_t entity, CString buffer, uint buffer_len);
    ...
    [DllImport(LibraryName)]
    public static extern ecs_entity_t ecs_set_ptr_w_entity(ecs_world_t* world, ecs_entity_t entity, ecs_id_t id, uint size, void* ptr);
    ...
    [DllImport(LibraryName)]
    public static extern ecs_entity_t ecs_new_module(ecs_world_t* world, ecs_entity_t e, CString name, uint size, uint alignment);
    ...
    {
        public delegate* unmanaged<ecs_world_t*, ecs_entity_t, ecs_entity_t*, ecs_entity_t*, void*, void*, uint, int, void*, void> Pointer;
    }
    ...
    {
        public delegate* unmanaged<ecs_world_t*, ecs_entity_t, ecs_entity_t*, void*, uint, int, void*, void> Pointer;
    }
    ...
    [StructLayout(LayoutKind.Explicit, Size = 192, Pack = 4)]
    public struct ecs_iter_t
    {
        ...
        [FieldOffset(108)] // size = 84, padding = 0
        ...
        public struct ecs_iter_t_iter
        {
            ...
            [FieldOffset(0)] // size = 68, padding = 16
    ...
    public struct ecs_snapshot_iter_t
    {
        ...
        [FieldOffset(44)] // size = 24, padding = 0
        public ecs_iter_table_t table;
    }
    ...
    [StructLayout(LayoutKind.Explicit, Size = 144, Pack = 4)]
    public struct ecs_term_t
    {
        ...
        [FieldOffset(12)] // size = 36, padding = 0
        public ecs_term_id_t pred;

        [FieldOffset(48)] // size = 72, padding = 0
        public fixed uint _args[72 / 4]; // ecs_term_id_t[2]
        ...
        [FieldOffset(140)] // size = 1, padding = 3
        public CBool move;
    }
    ...
    public struct ecs_term_id_t
    {
        ...
        [FieldOffset(16)] // size = 20, padding = 0
    ...
    public struct ecs_scope_iter_t
    {
        ...
        [FieldOffset(36)] // size = 20, padding = 0
        public ecs_map_iter_t tables;

        [FieldOffset(56)] // size = 4, padding = 0
        public int index;

        [FieldOffset(60)] // size = 24, padding = 0
        public ecs_iter_table_t table;
    }
    ...
    public struct ecs_writer_t
    {
        ...
        [FieldOffset(8)] // size = 68, padding = 0
    ...
    public struct ecs_table_writer_t
    {
        ...
        [FieldOffset(52)] // size = 16, padding = 0
    ...
    [StructLayout(LayoutKind.Explicit, Size = 472, Pack = 4)]
    public struct ecs_reader_t
    {
        ...
        [FieldOffset(204)] // size = 192, padding = 0
        public ecs_iter_t component_iter;

        [FieldOffset(396)] // size = 4, padding = 0
        public ecs_iter_next_action_t component_next;

        [FieldOffset(400)] // size = 72, padding = 0
    ...
    public struct ecs_table_reader_t
    {
        ...
        [FieldOffset(68)] // size = 1, padding = 3
    ...
    [StructLayout(LayoutKind.Explicit, Size = 2952, Pack = 4)]
    public struct ecs_system_desc_t
    {
        [FieldOffset(0)] // size = 544, padding = 0
        public ecs_entity_desc_t entity;

        [FieldOffset(544)] // size = 2360, padding = 0
        public ecs_query_desc_t query;

        [FieldOffset(2904)] // size = 4, padding = 0
        public ecs_iter_action_t callback;

        [FieldOffset(2908)] // size = 4, padding = 0
        public ecs_system_status_action_t status_callback;

        [FieldOffset(2912)] // size = 4, padding = 0
        public void* ctx;

        [FieldOffset(2916)] // size = 4, padding = 0
        public void* status_ctx;

        [FieldOffset(2920)] // size = 4, padding = 0
        public void* binding_ctx;

        [FieldOffset(2924)] // size = 4, padding = 0
        public ecs_ctx_free_t ctx_free;

        [FieldOffset(2928)] // size = 4, padding = 0
        public ecs_ctx_free_t status_ctx_free;

        [FieldOffset(2932)] // size = 4, padding = 0
        public ecs_ctx_free_t binding_ctx_free;

        [FieldOffset(2936)] // size = 4, padding = 0
        public float interval;

        [FieldOffset(2940)] // size = 4, padding = 0
        public int rate;

        [FieldOffset(2944)] // size = 8, padding = 0
        public ecs_entity_t tick_source;
    }

    // Struct @ flecs.h:405:3 (/Users/lstranks/Programming/c2cs/ext/flecs/include/flecs.h)
    [StructLayout(LayoutKind.Explicit, Size = 2360, Pack = 4)]
    public struct ecs_query_desc_t
    {
        [FieldOffset(0)] // size = 2324, padding = 0
        public ecs_filter_desc_t filter;

        [FieldOffset(2324)] // size = 8, padding = 0
        public ecs_id_t order_by_id;

        [FieldOffset(2332)] // size = 4, padding = 0
        public ecs_compare_action_t order_by;

        [FieldOffset(2336)] // size = 8, padding = 0
        public ecs_id_t group_by_id;

        [FieldOffset(2344)] // size = 4, padding = 0
        public ecs_rank_type_action_t group_by;

        [FieldOffset(2348)] // size = 4, padding = 0
        public ecs_query_t* parent;

        [FieldOffset(2352)] // size = 8, padding = 0
        public ecs_entity_t system;
    }

    // Struct @ flecs.h:371:3 (/Users/lstranks/Programming/c2cs/ext/flecs/include/flecs.h)
    [StructLayout(LayoutKind.Explicit, Size = 2324, Pack = 4)]
    public struct ecs_filter_desc_t
    {
        [FieldOffset(0)] // size = 2304, padding = 0
        public fixed uint _terms[2304 / 4]; // ecs_term_t[16]
        ...
        [FieldOffset(2304)] // size = 4, padding = 0
        public ecs_term_t* terms_buffer;

        [FieldOffset(2308)] // size = 4, padding = 0
        public int terms_buffer_count;

        [FieldOffset(2312)] // size = 1, padding = 3
        public CBool substitute_default;

        [FieldOffset(2316)] // size = 4, padding = 0
        public CString expr;

        [FieldOffset(2320)] // size = 4, padding = 0
        public CString name;
    }

    // Struct @ flecs.h:332:3 (/Users/lstranks/Programming/c2cs/ext/flecs/include/flecs.h)
    [StructLayout(LayoutKind.Explicit, Size = 544, Pack = 4)]
    public struct ecs_entity_desc_t
    {
        ...
        public fixed uint _add[256 / 4]; // ecs_id_t[32]
        ...
        [FieldOffset(280)] // size = 256, padding = 0
        public fixed uint _remove[256 / 4]; // ecs_id_t[32]
    ...
    public struct ecs_trigger_desc_t
    {
        ...
        [FieldOffset(696)] // size = 64, padding = 0
        public fixed uint _events[64 / 4]; // ecs_entity_t[8]
        ...
        [FieldOffset(760)] // size = 4, padding = 0
        public ecs_iter_action_t callback;

        [FieldOffset(764)] // size = 4, padding = 0
        public void* ctx;

        [FieldOffset(768)] // size = 4, padding = 0
        public void* binding_ctx;

        [FieldOffset(772)] // size = 4, padding = 0
        public ecs_ctx_free_t ctx_free;

        [FieldOffset(776)] // size = 4, padding = 0
        public ecs_ctx_free_t binding_ctx_free;
    }

    // Struct @ flecs.h:348:3 (/Users/lstranks/Programming/c2cs/ext/flecs/include/flecs.h)
    [StructLayout(LayoutKind.Explicit, Size = 804, Pack = 4)]
    public struct ecs_type_desc_t
    {
        [FieldOffset(0)] // size = 544, padding = 0
        public ecs_entity_desc_t entity;

        [FieldOffset(544)] // size = 256, padding = 0
        public fixed uint _ids[256 / 4]; // ecs_id_t[32]
    ...
    [StructLayout(LayoutKind.Explicit, Size = 808, Pack = 4)]
    public struct ecs_strbuf_t
    {
        ...
        [FieldOffset(16)] // size = 528, padding = 0
        public ecs_strbuf_element_embedded firstElement;

        [FieldOffset(544)] // size = 4, padding = 0
        public ecs_strbuf_element* current;

        [FieldOffset(548)] // size = 256, padding = 0
        public fixed uint _list_stack[256 / 4]; // ecs_strbuf_list_elem[32]
    ...
    [StructLayout(LayoutKind.Explicit, Size = 528, Pack = 4)]
