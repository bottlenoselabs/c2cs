...
typedef enum my_enum_week_day {
    MY_ENUM_WEEK_DAY_UNKNOWN,
    MY_ENUM_WEEK_DAY_MONDAY,
    MY_ENUM_WEEK_DAY_TUESDAY,
    MY_ENUM_WEEK_DAY_WEDNESDAY,
    MY_ENUM_WEEK_DAY_THURSDAY,
    MY_ENUM_WEEK_DAY_FRIDAY,
    _MY_ENUM_WEEK_DAY_FORCE_U32 = 0x7FFFFFFF
} my_enum_week_day;

MY_C_LIBRARY_API_DECL void hello_world(void);
MY_C_LIBRARY_API_DECL void invoke_callback(void f(const char*), const char* s);
