// <auto-generated>
//  This code was generated by the following tool on 2022-11-27 14:42:47 GMT-05:00:
...
namespace my_c_library_namespace
{
    public static unsafe partial class my_c_library
    {
        ...
        [CNode(Kind = "Function", Platform = "aarch64-apple-darwin", Location = "my_c_library.h:22:28")]
        [CNode(Kind = "Function", Platform = "x86_64-apple-darwin", Location = "my_c_library.h:22:28")]
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void hw_invoke_callback(FnPtr_CString_Void f, CString s);

        [CNode(Kind = "Function", Platform = "aarch64-apple-darwin", Location = "my_c_library.h:23:28")]
        [CNode(Kind = "Function", Platform = "x86_64-apple-darwin", Location = "my_c_library.h:23:28")]
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void hw_pass_string(CString s);

        [CNode(Kind = "Function", Platform = "aarch64-apple-darwin", Location = "my_c_library.h:24:28")]
        [CNode(Kind = "Function", Platform = "x86_64-apple-darwin", Location = "my_c_library.h:24:28")]
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void hw_pass_integers_by_value(ushort a, int b, ulong c);

        [CNode(Kind = "Function", Platform = "aarch64-apple-darwin", Location = "my_c_library.h:25:28")]
        [CNode(Kind = "Function", Platform = "x86_64-apple-darwin", Location = "my_c_library.h:25:28")]
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void hw_pass_integers_by_reference(ushort* a, int* b, ulong* c);

        [CNode(Kind = "Function", Platform = "aarch64-apple-darwin", Location = "my_c_library.h:26:28")]
        [CNode(Kind = "Function", Platform = "x86_64-apple-darwin", Location = "my_c_library.h:26:28")]
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
        ...
        [CNode(Kind = "Enum", Platform = "aarch64-apple-darwin", Location = "my_c_library.h:11:14")]
        [CNode(Kind = "Enum", Platform = "x86_64-apple-darwin", Location = "my_c_library.h:11:14")]
        ...
        [CNode(Kind = "TypeAlias", Platform = "aarch64-apple-darwin", Location = "my_c_library.h:19:3")]
        [CNode(Kind = "TypeAlias", Platform = "x86_64-apple-darwin", Location = "my_c_library.h:19:3")]
