...
public class CSharpCodeGenerator
{
    ...
    {
        var code = CompilationUnitTemplateCode(className, libraryName, @namespace, usingNamespaces);
        var syntaxTree = ParseSyntaxTree(code);
        var compilationUnit = syntaxTree.GetCompilationUnitRoot();

        ClassDeclarationSyntax classDeclaration;
        var isNamespaced = !string.IsNullOrEmpty(@namespace);
        if (isNamespaced)
        {
...
";
    ...
    {
        var values = EmitEnumValues(@enum.IntegerType.Name ?? string.Empty, @enum.Values);
...
";
    ...
    private static void EmitRuntime(ImmutableArray<MemberDeclarationSyntax>.Builder builder)
    {
