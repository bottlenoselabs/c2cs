...
public sealed class CSharpCodeMapper
{
        ...
        ImmutableDictionary<string, ImmutableArray<PlatformCandidateNode>.Builder>.Builder candidateNodes)
    {
        ...
        var key = node.Name + ":" + node.CKind + ":" + node.SizeOf;
        ...
        CFunctionCallingConvention callingConvention)
    {
        ...
        {
            CFunctionCallingConvention.Cdecl => C2CS.Data.CSharp.Model.CSharpFunctionCallingConvention.Cdecl,
            CFunctionCallingConvention.StdCall => C2CS.Data.CSharp.Model.CSharpFunctionCallingConvention.StdCall,
            CFunctionCallingConvention.FastCall => C2CS.Data.CSharp.Model.CSharpFunctionCallingConvention.FastCall,
