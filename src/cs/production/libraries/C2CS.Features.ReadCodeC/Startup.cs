...
using ClangArgumentsBuilder = C2CS.ReadCodeC.Domain.Parse.ClangArgumentsBuilder;
using ExploreHandler = C2CS.ReadCodeC.Domain.Explore.ExploreHandler;
...
public static class Startup
{
    public static void ConfigureServices(IServiceCollection services)
    {
        ...
        // Use case
        services.AddTransient<FeatureReadCodeC>();
        services.AddSingleton<ReadCodeCInputValidator>();
