...
public sealed class InputValidator : InputValidator<WriterCSharpCodeOptions, Input>
{
    ...
    public override Input Validate(WriterCSharpCodeOptions options)
    {
...
[PublicAPI]
public abstract class InputValidator<TOptions, TInput> : Foundation.UseCases.InputValidator<TOptions, TInput>
