...
public sealed class InputSanitizer : ToolInputSanitizer<InputUnsanitized, InputSanitized>
{
    ...
    private static CSharpCodeMapperOptions MapperOptions(InputUnsanitized unsanitizedInput)
    {
    ...
    private CSharpCodeGeneratorOptions GeneratorOptions(InputUnsanitized unsanitizedInput)
    {
    ...
    private static ImmutableArray<CSharpMappedName> MappedNames(
        ImmutableArray<InputUnsanitizedMappedName>? mappedNames)
    {
