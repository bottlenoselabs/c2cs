...
public static unsafe partial class clang
{
    ...
    // Typedef @ corecrt.h:645:28 (C:\Program Files (x86)\Windows Kits\10\Include\10.0.22000.0\ucrt\corecrt.h)
    [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
    public struct time_t
    {
        [FieldOffset(0)] // size = 8, padding = 0
        public __time64_t Data;

        public static implicit operator __time64_t(time_t data) => data.Data;
        public static implicit operator time_t(__time64_t data) => new() { Data = data };
    }

    // Typedef @ corecrt.h:608:39 (C:\Program Files (x86)\Windows Kits\10\Include\10.0.22000.0\ucrt\corecrt.h)
    [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
    public struct __time64_t
    {
        ...
        public static implicit operator long(__time64_t data) => data.Data;
