...
public sealed class ReadCodeCInputValidator : ExecutorInputValidator<ReaderCCodeOptions, ReadCodeCInput>
{
    private readonly IFileSystem _fileSystem;

    public ReadCodeCInputValidator(IFileSystem fileSystem)
    {
    ...
    private ImmutableArray<ReadCodeCInputAbstractSyntaxTree> OptionsList(
        ReaderCCodeOptions configuration,
        string inputFilePath)
    {
        var optionsBuilder = ImmutableArray.CreateBuilder<ReadCodeCInputAbstractSyntaxTree>();
    ...
    private ReadCodeCInputAbstractSyntaxTree Options(
        ReaderCCodeOptions configuration,
        ...
        string inputFilePath)
    {
        ...
        var inputAbstractSyntaxTree = new ReadCodeCInputAbstractSyntaxTree
        {
            TargetPlatform = targetPlatform,
