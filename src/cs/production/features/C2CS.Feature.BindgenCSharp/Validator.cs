...
public class Validator : UseCaseValidator<RequestBindgenCSharp, Input>
{
    public override Input Validate(RequestBindgenCSharp request)
    {
        ...
        var headerCodeRegion = VerifyHeaderCodeRegion(request.HeaderCodeRegionFilePath);
        var footerCodeRegion = VerifyFooterCodeRegion(request.FooterCodeRegionFilePath);
