...
{
    private static readonly Action<ILogger, string, Exception> ActionReadAbstractSyntaxTreeSuccess = LoggerMessage.Define<string>(
    ...
    private static readonly Action<ILogger, string, Exception> ActionReadAbstractSyntaxTreeFailure = LoggerMessage.Define<string>(
        LogLevel.Information,
    ...
    private static readonly Action<ILogger, string, Exception> ActionWriteAbstractSyntaxTreeSuccess = LoggerMessage.Define<string>(
        LogLevel.Information,
    ...
    private static readonly Action<ILogger, string, Exception> ActionWriteAbstractSyntaxTreeFailure = LoggerMessage.Define<string>(
        LogLevel.Information,
