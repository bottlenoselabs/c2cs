...
using C2CS.Feature.ExtractAbstractSyntaxTreeC.Domain.Model;
...
public class ClangTranslationUnitExplorer
{
    ...
    private readonly ArrayDeque<ClangExplorerNode> _frontierGeneral = new();
    private readonly ArrayDeque<ClangExplorerNode> _frontierMacros = new();
