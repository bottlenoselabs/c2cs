...
public class Validator : UseCaseValidator<RequestExtractAbstractSyntaxTreeC, Input>
{
    public override Input Validate(RequestExtractAbstractSyntaxTreeC request)
    {
