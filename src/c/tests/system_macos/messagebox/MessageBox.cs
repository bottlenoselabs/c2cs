// <auto-generated>
//  This code was generated by the following tool on 2022-05-08 15:54:09 GMT-04:00:
...
using static bottlenoselabs.MessageBox.Runtime;

namespace bottlenoselabs
{
    public static unsafe partial class MessageBox
    {
        private const string LibraryName = "MessageBox";

        #region API

        // Function @ CFUserNotification.h:102:8 (Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/System/Library/Frameworks/CoreFoundation.framework/Headers/CFUserNotification.h)
        ...
        // TypeAlias @ CFDate.h:18:16 (Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/System/Library/Frameworks/CoreFoundation.framework/Headers/CFDate.h)
        [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 4)]
        public struct CFTimeInterval
        {
            [FieldOffset(0)] // size = 8, padding = 0
            public double Data;

            public static implicit operator double(CFTimeInterval data) => data.Data;
            public static implicit operator CFTimeInterval(double data) => new() { Data = data };
        }
        ...
        public struct CFStringRef
        {
            ...
            public __CFString* Data;

            public static implicit operator __CFString*(CFStringRef data) => data.Data;
            public static implicit operator CFStringRef(__CFString* data) => new() { Data = data };
        }

        // TypeAlias @ CFURL.h:27:55 (Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/System/Library/Frameworks/CoreFoundation.framework/Headers/CFURL.h)
        [StructLayout(LayoutKind.Explicit, Size = 4, Pack = 4)]
        public struct CFURLRef
        {
            [FieldOffset(0)] // size = 4, padding = 0
            public __CFURL* Data;

            public static implicit operator __CFURL*(CFURLRef data) => data.Data;
            public static implicit operator CFURLRef(__CFURL* data) => new() { Data = data };
        }

        // TypeAlias @ CFBase.h:473:23 (Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/System/Library/Frameworks/CoreFoundation.framework/Headers/CFBase.h)
        [StructLayout(LayoutKind.Explicit, Size = 4, Pack = 4)]
        public struct CFOptionFlags
        {
            [FieldOffset(0)] // size = 4, padding = 0
            public uint Data;

            public static implicit operator uint(CFOptionFlags data) => data.Data;
            public static implicit operator CFOptionFlags(uint data) => new() { Data = data };
        }

        #endregion

        #region Bindgen.Runtime
