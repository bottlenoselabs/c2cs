...
1. If you are not using .NET Core 3.1+ or .NET 5+ then things possibly won't work when passing structs by value in some contexts. https://docs.microsoft.com/en-us/dotnet/standard/native-interop/customize-struct-marshaling
